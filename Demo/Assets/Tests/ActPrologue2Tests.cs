...
public class ActPrologue2Tests
{
    [UnityTest]
    public IEnumerator PrologueInstant2()
    {
    ...
    [UnityTest]
    public IEnumerator PrologueSeqInstant2()
    {
        var executionOrder = new List<string>();
        var actA1 = new Act();
        actA1.OnPreEnter += (a) => executionOrder.Add(a.GetName());
    ...
    [UnityTest]
    public IEnumerator PrologueInstant2x2()
    {
        var executionOrder = new List<string>();
        var actA1 = new Act();
        actA1.OnPreEnter += (a) => executionOrder.Add(a.GetName());
    ...
    [UnityTest]
    public IEnumerator PrologueTimed2x2()
    {
    ...
    [UnityTest]
    public IEnumerator PrologueSeqInstant2x2()
    {
        var executionOrder = new List<string>();
        var actA1 = new Act();
        actA1.OnPreEnter += (a) => executionOrder.Add(a.GetName());
    ...
    [UnityTest]
    public IEnumerator PrologueSeqTimed2x2()
    {
        var theater = new GameObject("Theater").AddComponent<Theater>();
        var executionOrder = new List<string>();
        var actA1 = new SingleTickAct();
    ...
    [UnityTest]
    public IEnumerator PrologueInstant2x2x2()
    {
        var executionOrder = new List<string>();
        var actA1 = new Act();
        actA1.OnPreEnter += (a) => executionOrder.Add(a.GetName());
    ...
    [UnityTest]
    public IEnumerator PrologueTimed2x2x2()
    {
        var theater = new GameObject("Theater").AddComponent<Theater>();
        var executionOrder = new List<string>();
        var actA1 = new SingleTickAct();
    ...
    [UnityTest]
    public IEnumerator PrologueSeqInstant2x2x2()
    {
        var executionOrder = new List<string>();
        var actA1 = new Act();
        actA1.OnPreEnter += (a) => executionOrder.Add(a.GetName());
    ...
    [UnityTest]
    public IEnumerator PrologueSeqTimed2x2x2()
    {
        var theater = new GameObject("Theater").AddComponent<Theater>();
        var executionOrder = new List<string>();
        var actA1 = new SingleTickAct();
