...
public class ActPrologue3Tests
{
    [UnityTest]
    public IEnumerator PrologueInstant3()
    {
        ...
        Utilities.AssertChainCleared(actA3);
    ...
    [UnityTest]
    public IEnumerator PrologueSeqInstant3()
    {
        var executionOrder = new List<string>();
        var actA1 = new Act();
        actA1.OnPreEnter += (a) => executionOrder.Add(a.GetName());
        ...
        Utilities.AssertChainCleared(actA3, suffix: " in Seq() variation");
    ...
    [UnityTest]
    public IEnumerator PrologueInstant3x3()
    {
        var executionOrder = new List<string>();
        var actA1 = new Act();
        actA1.OnPreEnter += (a) => executionOrder.Add(a.GetName());
        ...
        Utilities.AssertChainCleared(actA3, prefix: "Instant: ");
        Utilities.AssertChainCleared(actB1, prefix: "Instant: ");
        Utilities.AssertChainCleared(actB2, prefix: "Instant: ");
        Utilities.AssertChainCleared(actB3, prefix: "Instant: ");
    ...
    [UnityTest]
    public IEnumerator PrologueTimed3x3()
    {
        ...
        Utilities.AssertChainCleared(actA3, prefix: "Timed: ");
        Utilities.AssertChainCleared(actB1, prefix: "Timed: ");
        Utilities.AssertChainCleared(actB2, prefix: "Timed: ");
        Utilities.AssertChainCleared(actB3, prefix: "Timed: ");
    ...
    [UnityTest]
    public IEnumerator PrologueSeqInstant3x3()
    {
        var executionOrder = new List<string>();
        var actA1 = new Act();
        actA1.OnPreEnter += (a) => executionOrder.Add(a.GetName());
        ...
        Utilities.AssertChainCleared(actA3, prefix: "Instant: ", suffix: " in Seq() variation");
        ...
        Utilities.AssertChainCleared(actB3, prefix: "Instant: ", suffix: " in Seq() variation");
    ...
    [UnityTest]
    public IEnumerator PrologueSeqTimed3x3()
    {
        var theater = new GameObject("Theater").AddComponent<Theater>();
        var executionOrder = new List<string>();
        var actA1 = new SingleTickAct();
        ...
        Utilities.AssertChainCleared(actA3, prefix: "Timed: ", suffix: " in Seq() variation");
        ...
        Utilities.AssertChainCleared(actB3, prefix: "Timed: ", suffix: " in Seq() variation");
    ...
    [UnityTest]
    public IEnumerator PrologueInstant3x3x3()
    {
        var executionOrder = new List<string>();
        var actA1 = new Act();
        actA1.OnPreEnter += (a) => executionOrder.Add(a.GetName());
        ...
        Utilities.AssertChainCleared(actC3, prefix: "Instant: ");
        Utilities.AssertChainCleared(mainAct, prefix: "Instant: ");
    ...
    [UnityTest]
    public IEnumerator PrologueTimed3x3x3()
    {
        var theater = new GameObject("Theater").AddComponent<Theater>();
        var executionOrder = new List<string>();
        var actA1 = new SingleTickAct();
        ...
        Utilities.AssertChainCleared(actC3, prefix: "Timed: ");
        Utilities.AssertChainCleared(mainAct, prefix: "Timed: ");
    ...
    [UnityTest]
    public IEnumerator PrologueSeqInstant3x3x3()
    {
        var executionOrder = new List<string>();
        var actA1 = new Act();
        actA1.OnPreEnter += (a) => executionOrder.Add(a.GetName());
        ...
        Utilities.AssertChainCleared(actC3, prefix: "Instant: ", suffix: " in Seq() variation");
        Utilities.AssertChainCleared(mainAct, prefix: "Instant: ", suffix: " in Seq() variation");
    ...
    [UnityTest]
    public IEnumerator PrologueSeqTimed3x3x3()
    {
        var theater = new GameObject("Theater").AddComponent<Theater>();
        var executionOrder = new List<string>();
        var actA1 = new SingleTickAct();
        ...
        Utilities.AssertChainCleared(actC3, prefix: "Timed: ", suffix: " in Seq() variation");
        Utilities.AssertChainCleared(mainAct, prefix: "Timed: ", suffix: " in Seq() variation");
